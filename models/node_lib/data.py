...
class Dataset:
    ...
    def __init__(self, dataset, random_state, data_path='./data', normalize=False,
        ...
        if dataset in DATASETS:
            ...
            assert all(key in kwargs for key in ('X_train', 'y_train', 'X_valid', 'y_valid')), \
                "Unknown dataset. Provide X_train, y_train, X_valid, y_valid params"
            # , 'X_test', 'y_test'   , X_test and y_test
            data_dict = kwargs
        ...
        # Adapted this for own experiment format
